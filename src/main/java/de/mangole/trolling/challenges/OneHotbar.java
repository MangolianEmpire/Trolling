...
public class OneHotbar extends CustomChallenge {

    Set<Integer> allowedSlots = Set.of(0, 1, 2, 3, 4, 5, 6, 7, 8, 36, 37, 38, 39, 40);

    public OneHotbar(Trolling trolling) {
        super(trolling, "One Hotbar");
    }
